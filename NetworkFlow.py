...
if __name__ == "__main__":
    """Test case. Duh!"""
    print("Here is starting point i.e main\n")
    ...
    print("After def metric")
    ss = ServerSpace(metric)
    ss.add_servers([(5, 0), (9, 0), (20, 0)])
    print(ss.process_requests([(11,0),(1,0),(3,0),(7,0),(17,0),(4,0),(6,0),(5,0),(17,0),(4,0)]))  # OPTCOST =18
